...
<head>
    ...
    <script>
        ...
        <#list itemList as item>
            {
                'id':${item.id?c},/*c表示去掉逗号，id是long类型*/
                'title':'${item.title}',/*title是字符串类型，需要加引号*/
                'price':${item.price?c},/*price是数字类型*/
                'spec':${item.spec}/*spec表示规格，是一个对象不是字符串*/
            },
        </#list>
        ];
    </script>
